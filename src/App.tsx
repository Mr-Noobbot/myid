          ...
          >
            <div>
              ...
              <div style={{ fontSize: 12, color: TOKENS.muted, marginTop: 4 }}>
                Jhapa, Birtamode-10, Nepal
              </div>
              <span
                className="jv-mono"
                style={{ color: TOKENS.muted, fontSize: 12, marginTop: 16, display: "block" }}
              >
            ...
            <div style={{ display: "flex", gap: 20 }}>
              <a href="https://www.instagram.com/sherpabishal_14/" aria-label="Instagram" className="jv-social">
                <Instagram size={20} />
              </a>
              <a href="https://www.youtube.com/channel/UCDrWFVilncWWtdtlVcABtlg" aria-label="YouTube" className="jv-social">
                <Youtube size={20} />
              </a>
              <a href="https://www.linkedin.com/in/bishal-sherpa-1a418728a/" aria-label="LinkedIn" className="jv-social">
                <Linkedin size={20} />
              </a>
            </div>
          </div>
